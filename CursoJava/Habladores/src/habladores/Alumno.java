...
public class Alumno extends Persona implements hablador{
	...
	public String hablar() {
		...
		return "Hola, soy un Alumno y sé hablar";
	}
	...
	public String toString() {
		// TODO Auto-generated method stub
		return hablar() + "\nNombre "  +this.nombre + " tengo " + this.edad + " años " + " Estoy estudiando la carrera de " + this.carrera + " y estoy en el " + this.curso + " curso";
	}
